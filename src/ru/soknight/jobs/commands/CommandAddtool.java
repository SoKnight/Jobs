...
public class CommandAddtool {
	...
	public static void execute(CommandSender sender, String[] args) {
		...
		SelectionTool tool = SelectionToolsHandler.addTool(job, Operation.ADD);
		ItemStack item = tool.getItemStack();
		
		inv.addItem(item);
		p.sendMessage(Utils.pformat("select-add-tool", "job@@" + job.getName()));
		return;
	}
