...
public class Database {
	...
	public Database() throws Exception {
		...
		if(database_type.equals("mysql")) {
			...
			database_url = "jdbc:sqlite:" + Jobs.getInstance().getDataFolder() + File.separator + sqlite_file;
		...
		s.executeUpdate("CREATE TABLE IF NOT EXISTS workers (player TEXT, job TEXT, level INT, progress INT);");
		s.executeUpdate("CREATE TABLE IF NOT EXISTS blocks (world TEXT, x INT, y INT, z INT, job TEXT);");
